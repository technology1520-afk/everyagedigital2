    ...
    <div className="py-2">
      <ProductForm
        ...
        initialData={{
          ...
          priceMin: offer && typeof offer.price === 'number' && !isNaN(offer.price) ? offer.price : 99,
          priceMax: offer && typeof offer.originalPrice === 'number' && !isNaN(offer.originalPrice) ? offer.originalPrice : undefined,
