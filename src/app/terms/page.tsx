    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 space-y-6 text-xs sm:text-sm text-slate-300 leading-relaxed shadow-xl">
        <section className="space-y-2">
          <h2 className="font-serif text-lg font-bold text-white">1. Acceptance of Terms</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-lg font-bold text-white">2. Informational & Discovery Platform Only</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-lg font-bold text-white">3. Price & Availability Accuracy</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-lg font-bold text-white">4. Owned Digital Products & Refund Policy</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-lg font-bold text-white">5. Limitation of Liability</h2>
          <p>
